...
export default function PatientCreate() {
    ...
    return (
        <>
            ...
            <Container maxW="7xl" px={{ base: '4', md: '6', lg: '8' }} py={{ base: '6', lg: '8' }} w="fit-content">
                <Stack gap="6" p={{ base: '6', lg: '8' }} maxW="3xl" w="auto">
                    <Box>
                    ...
                    <Box as="form" onSubmit={submit}>
                        <Stack gap="5">
                            ...
                            >
                                ...
                                <Grid templateColumns={{ base: '1fr', sm: 'repeat(2, 1fr)' }} gap="10">
                                    <Stack gap="1.5">
