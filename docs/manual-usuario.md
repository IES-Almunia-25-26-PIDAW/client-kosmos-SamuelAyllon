...
5. Recibirás un correo de verificación. Haz clic en el enlace para activar tu cuenta.

> Al registrarte, se te asigna automáticamente el **plan gratuito**.
...
Si has olvidado tu contraseña, haz clic en **"¿Olvidaste tu contraseña?"** e introduce tu email para recibir un enlace de recuperación.

---

### Autenticación de dos factores (2FA)

Para mayor seguridad, puedes activar la autenticación en dos pasos:

1. Ve a **Configuración → Autenticación en dos factores**.
...
Una vez activado, cada inicio de sesión te pedirá el código de tu aplicación.
...
Accede desde el sidebar a **"Tareas"**. Verás la lista ordenada por:
...
En la lista de tareas, haz clic en el botón **"Completar"** (icono de check) junto a la tarea. La tarea se moverá a la sección de completadas y quedará registrada la fecha de finalización.

---

### Reabrir una tarea

Si necesitas volver a trabajar en una tarea completada:

1. Haz clic en el botón **"Reabrir"** junto a la tarea completada.
2. La tarea vuelve a estado "pendiente".

> Si ya tienes 5 tareas pendientes (plan gratuito), no podrás reabrir más hasta que completes alguna.

---

### Editar o eliminar una tarea

- **Editar**: haz clic en el icono de lápiz junto a la tarea. Modifica los campos y guarda.
- **Eliminar**: haz clic en el icono de papelera. La tarea se elimina permanentemente.
...
Accede desde el sidebar a **"Suscripción"**. Verás:
- Tu plan actual y su estado
...
En **"Apariencia"** puedes alternar entre el **tema claro** y el **tema oscuro**. La preferencia se guarda en tu navegador.
...
- Total de usuarios, tareas, ideas y pagos
- Usuarios y pagos recientes
...
- Ver la lista completa de usuarios con su rol, plan y actividad
- Consultar el detalle de cada usuario (historial de pagos, suscripción, tareas e ideas)
- Eliminar usuarios
...
En **"Pagos"** el administrador puede ver:
- Resumen de ingresos totales
- Lista de todos los pagos con estado (pendiente / completado / fallido) e importe

---

### Gestión de suscripciones

En **"Suscripciones"** el administrador puede ver:
- Distribución de usuarios por plan
- Lista detallada de todas las suscripciones activas y expiradas
...
En esta versión los pagos son simulados. Solo se almacenan los últimos 4 dígitos de la tarjeta, nunca el número completo.
...
**¿Cómo activo la autenticación en dos factores?**
Ve a **Configuración → Autenticación en dos factores** y sigue los pasos descritos en la sección 1 de este manual.

---

**¿Puedo recuperar una tarea eliminada?**
No. La eliminación de tareas es permanente. Las tareas completadas, en cambio, pueden reabrirse en cualquier momento.
